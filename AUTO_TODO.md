...
- [x] 5.1 后台扫描任务调度器（AI 自动扫描代码变更）
- [x] 5.2 AI 代码审查 prompt 模板
- [x] 5.3 审查结果解析 + 写入 reviews 队列
- [x] 5.4 批准操作 → AI 自动修复流程
- [x] 5.5 构建验证 + 回归测试

## Phase 6 — 开发记忆

- [x] 6.1 DevMemoryContext 构建器（汇总会话/任务/审查信息）
- [x] 6.2 会话摘要自动生成
- [x] 6.3 记忆 API 端点
- [x] 6.4 Chat 面板记忆横幅
- [x] 6.5 构建验证 + 回归测试
